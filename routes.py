...
@routes.route('/World_Cover', methods=['GET', 'POST'])
def World_Cover():
    form = ProductForm()
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('routes.Model_World_Cover', form=form))

    return render_template('World_Cover.html', form=form)
...
# @routes.route('/Model_World_Cover', methods=['GET', 'POST'])
# def Model_World_Cover():
